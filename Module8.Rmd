...
```{r, "Weather Set up",echo=FALSE,warning=FALSE,message=FALSE,fig.cap='Fig.1. Weather sampling locations for this project.'}
...
```{r, "EBird Data Modeling For Cape May Warbler (st)",echo=FALSE,warning=FALSE,message=FALSE}
st<- dat%>%
...
```{r, "EBird Data Modeling For Yellow-Rumped Warbler (sc)",echo=FALSE,warning=FALSE,message=FALSE}
sc<- dat%>%
...
```{r, "EBird Data Modeling For Palm Warbler (sp)",echo=FALSE,warning=FALSE,message=FALSE}
sp<- dat%>%
...
```{r, "EBird Data Modeling For Black-Throated Green Warbler (sv)",echo=FALSE,warning=FALSE,message=FALSE}
sv<- dat%>%
...
```{r, "Weather Data Prep",echo=FALSE,warning=FALSE,message=FALSE}
#single day data
weather.d <- weather.d%>%
...
```{r, "eBird and weather data joinnig for Magnolia Warbler",echo=FALSE,warning=FALSE,message=FALSE}
...
```{r, "eBird and weather data joinnig for Cape May Warbler", echo=FALSE, message=FALSE}
...
```{r, "eBird and weather data joinnig for Yellow-Rumped Warbler",echo=FALSE,warning=FALSE,message=FALSE}
...
```{r, "eBird and weather data joinnig for Palm Warbler",echo=FALSE,warning=FALSE,message=FALSE}
...
```{r, "eBird and weather data joinnig for Black-Throated Green Warbler",echo=FALSE,warning=FALSE,message=FALSE}
